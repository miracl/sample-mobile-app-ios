...
## Description
This sample demonstrates how to use the (MIRACL iOS SDK)[link to https://github.com/miracl/mfa-client-sdk-ios] in order create sign documents using MIRACL MFA Platform[link] authentication via an iOS device. This is the so called `DVS` flow and here is the methods sequence you need to achieve it:
